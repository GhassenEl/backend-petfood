...
const demoPack = () => ({
  ...
  alerts: [
    ...
    { id: 'a2', source: 'water', severity: 'high', title: 'Hydratation Luna', message: '66 % de l\'objectif journalier — encouragez à boire.', deviceId: 'demo-water-2', link: '/client-smart-water' },
    ...
    { id: 'a4', source: 'feeder', severity: 'low', title: 'Prochain repas Max', message: 'Distribution programmée à 19:30 (30 g).', deviceId: 'demo-feeder-1', link: '/pet-feeder' },
  ],
  automations: [
